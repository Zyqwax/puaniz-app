  ...
  return (
    ...
    >
      <div>
        ...
        <p
          className={`text-xs ${subtext && subtext.includes("+") ? "text-green-400" : "text-slate-500"}`}
        >
          {subtext}
        </p>
      </div>
      <div
        className={`p-3 rounded-xl bg-${color}-500/10 text-${color}-400 flex items-center gap-2`}
      >
        <Icon size={24} />
        ...
        <>
            ...
            <div className="glass-card">
              ...
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={tytData} margin={{ bottom: 50 }}>
                    <defs>
          ...
          {aytData.length > 0 && (
            <div className="glass-card">
              ...
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={aytData} margin={{ bottom: 50 }}>
                    <defs>
                      <linearGradient
                        id="colorAytNet"
                        x1="0"
          ...
          {tytData.length === 0 && aytData.length === 0 && (
            <div className="glass-card text-center py-12">
              <p className="text-slate-400 text-lg">Henüz deneme verisi yok.</p>
              <p className="text-slate-500 text-sm mt-2">
                İlk denemeni ekledikten sonra grafikler burada görünecek.
              </p>
            </div>
          )}
        </>
