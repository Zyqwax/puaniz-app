...
import { auth } from "@/lib/firebase"; // Required for direct auth.currentUser usage in services if needed (though we pass uid usually)
...
const AddExam = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto pb-20">
      <title>Deneme Ekle - Puanİz</title>
      <meta
        name="description"
        content="TYT ve AYT deneme sonuçlarınızı sisteme girin, netlerinizi ve puanlarınızı anında hesaplayın."
      />
