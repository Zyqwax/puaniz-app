...
const Community = () => {
  ...
  return (
    <div className="h-full flex flex-col pb-20">
      <title>Topluluk - Puanİz</title>
      <meta
        name="description"
        content="Diğer öğrencilerle etkileşime geçin, sorular sorun ve tecrübelerinizi paylaşın."
      />
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white rounded-xl shadow-lg shadow-purple-900/20 hover:shadow-purple-900/40 transition-all active:scale-95 font-medium whitespace-nowrap shrink-0"
          >
            <Plus size={20} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 hidden lg:block">
          <div className="sticky top-4 space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-900/20 to-slate-900 rounded-xl p-4 border border-white/5">
