...
const Analysis = () => {
  ...
  return (
    <div className="space-y-6 pb-20">
      <title>Detaylı Analiz - Puanİz</title>
      <meta
        name="description"
        content="Ders bazlı net grafikleri ve gelişim raporları ile eksiklerinizi tespit edin."
      />
      ...
      {aiAnalysis && (
        <div className="bg-gradient-to-r from-blue-900/40 to-purple-900/40 border border-blue-500/30 p-6 rounded-xl relative overflow-hidden group hover:border-blue-500/50 transition-all">
