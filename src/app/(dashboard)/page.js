...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      <title>Puanİz - Ana Sayfa</title>
      <meta
        name="description"
        content="YKS hazırlık sürecinizi yönetin, deneme sınavlarınızı takip edin ve gelişiminizi izleyin."
      />
      <meta name="keywords" content="yks takip, deneme analizi, puan hesaplama, yks 2026" />
