            ...
            {isEditing ? (
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0">
                  <h2 className="text-xl sm:text-2xl font-bold text-white break-words">{exam.name}</h2>
...
const History = () => {
  ...
  return (
    <div className="space-y-6 pb-20">
      <title>Deneme Geçmişi - Puanİz</title>
      <meta
        name="description"
        content="Girdiğiniz tüm deneme sınavlarının geçmişini ve detaylı listesini görüntüleyin."
      />
