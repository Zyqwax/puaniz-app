    ...
    try {
      if (isLogin) {
        ...
        await updateUserProfile(user.uid, {
          ...
          email: email,
          createdAt: new Date(),
          avatarUrl: `https://ui-avatars.com/api/?name=${encodeURIComponent(name)}&background=random`, // Default avatar
          grade: "",
        });
      }
      router.push("/");
      ...
      console.error(err);
      setError(err.message.replace("Firebase:", "").trim()); // Basic error cleanup
    }
  };
  ...
  return (
    <PublicRoute>
      <div className="min-h-screen flex items-center justify-center p-4">
        <title>Giriş Yap / Kayıt Ol - Puanİz</title>
        <meta
          name="description"
          content="Puanİz hesabınıza giriş yapın veya ücretsiz kayıt olarak YKS hazırlık sürecinizi profesyonelce yönetmeye başlayın."
        />
        <meta name="keywords" content="giriş yap, kayıt ol, ücretsiz üyelik, yks koçluk" />
